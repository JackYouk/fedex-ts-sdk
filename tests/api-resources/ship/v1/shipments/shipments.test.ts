...
describe('resource shipments', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.ship.v1.shipments.create({
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.ship.v1.shipments.create({
      accountNumber: { value: 'Your account number' },
      labelResponseOptions: 'URL_ONLY',
      requestedShipment: {
        labelSpecification: {
        ...
        shipmentSpecialServices: {
          ...
          specialServiceTypes: ['THIRD_PARTY_CONSIGNEE', 'PROTECTION_FROM_FREEZING'],
        },
  ...
  test.skip('cancel: only required params', async () => {
    const responsePromise = client.ship.v1.shipments.cancel({
      accountNumber: { value: 'Your account number' },
  ...
  test.skip('cancel: required and optional params', async () => {
    const response = await client.ship.v1.shipments.cancel({
      accountNumber: { value: 'Your account number' },
      trackingNumber: '794953555571',
  ...
  // skipped: tests are disabled for the time being
  test.skip('retrieveAsync: only required params', async () => {
    const responsePromise = client.ship.v1.shipments.retrieveAsync({
      accountNumber: {},
  ...
  // skipped: tests are disabled for the time being
  test.skip('retrieveAsync: required and optional params', async () => {
    const response = await client.ship.v1.shipments.retrieveAsync({
      accountNumber: { value: 'Your account number' },
      jobId: '89sxxxxx233ae24ff31xxxxx',
