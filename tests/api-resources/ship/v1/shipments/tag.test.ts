...
describe('resource tag', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.ship.v1.shipments.tag.create({
      accountNumber: {},
      requestedShipment: {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.ship.v1.shipments.tag.create({
  ...
  test.skip('cancel: only required params', async () => {
    const responsePromise = client.ship.v1.shipments.tag.cancel('shipmentid', {
      accountNumber: {},
      completedTagDetail: { confirmationNumber: '275', dispatchDate: '2019-08-03', location: 'NQAA' },
      serviceType: 'PRIORITY_OVERNIGHT',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('cancel: required and optional params', async () => {
    const response = await client.ship.v1.shipments.tag.cancel('shipmentid', {
